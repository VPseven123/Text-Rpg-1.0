...
cls
echo Thanks for playing!
echo Made By VPseven
echo.
echo TextRpg
:Start_1
cls
echo your living a happy life!
echo But suddenly...
echo The EXHOSoldiers Attacked The Village
echo Your Parents putted you in the Woods
echo and then.
echo you heard your parents crying
echo then suddenly you heared nothing.
echo stareing into the nothingness...
echo you stayed for 10 years in the woods you found many animals as friends.
echo suddenly a warrior came and said (Hey Are you Alone Here?)
echo you said (Wait! I Dont Wanna Die! Leave ME Alone!)
echo the warrior again said (im not here to hurt you. im here to make you a warrior)
echo you said (But Why?)
echo the warrior said (i saw your parents put you in the woods. i felt bad. i decided i want you to fight your enemies!)
echo you said in your mind (wait. if i become a warrior i can fight my own enemies. that means more revenge!)
set /p answer=Would you Accept this Offer?
if %answer%==yes goto Story_1
if %answer%==no goto End_1
pause
:End_1
cls
echo you declined the offer, he left. you chose to stay in the woods forever.
pause
exit /b
:Story_1
echo you are Now in Town.
echo Warrior: My Name is Markus but you can call me Mark
echo Warrior: This is your home
echo *****************************
echo *****************************
echo *****************************
echo *****************************
...
echo *********        ************
echo *****************************
echo warrior: now you can do anything you want! buy,eat,sleep everything!
set /p answer=Do you want to stay?
if %answer%==yes goto game_1
if %answer%==no goto stop_2
:stop_2
echo you got thrown in the woods again...
pause
exit /b
:game_1
echo.
echo 1. Fight
echo 2. Survival Singleplayer (The Wild)
set /p answer=What do you want to Do?
if %answer%==1 Goto Fight_1
if %answer%==2 goto Survival_1
:Fight_1
echo you: The Battlefield? Wish me Luck...
